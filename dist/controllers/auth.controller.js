...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = jsonwebtoken_1.default.sign({ _id: savedUser._id }, process.env.JWT_TOKEN_SECRET);
...
const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = jsonwebtoken_1.default.sign({ _id: user._id }, process.env.JWT_TOKEN_SECRET, { expiresIn: 60 * 60 * 24 });
